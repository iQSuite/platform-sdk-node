...
class IQSuiteClient {
    ...
    createIndex(document, filename) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const headers = axios_1.AxiosHeaders.from(Object.assign(Object.assign({}, this.client.defaults.headers.common), formData.getHeaders()));
    ...
    retrieve(indexId, query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.client.post("/index/retrieve", {
                    index: indexId,
                    query,
                });
                return this.handleResponse(response);
